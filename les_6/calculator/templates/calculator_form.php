...
$operationTitle = "Введи аргументы и выбери математическую операцию";
?>
<h2 class="flexCenter"><?= $form_title ?></h2>
<form class="flexCenter" action="" enctype="multipart/form-data" method="post">

    <div class="formDiv">
        <h4 class="flexCenter"><?= $operationTitle ?></h4>
        <p>Аргумент 1: <input type="number" class="formInput" name='arg1' value="0"></p>
        <p>Аргумент 2: <input type="number" class="formInput" name='arg2' value="0"></p>
    </div>
